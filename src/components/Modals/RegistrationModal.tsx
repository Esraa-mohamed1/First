                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <input type="text" placeholder="أدخل اسمك بالكامل" className="w-full p-4 pr-12 text-right bg-[#f8faff] border border-[#e2e8f0] rounded-2xl focus:border-[#2563eb] outline-none transition-all font-bold" />
                            ...
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <input type="email" placeholder="example@mail.com" className="w-full p-4 pr-12 text-right bg-[#f8faff] border border-[#e2e8f0] rounded-2xl focus:border-[#2563eb] outline-none transition-all font-bold" />
                            ...
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <input type="tel" placeholder="05xxxxxxxx" className="w-full p-4 pr-12 text-right bg-[#f8faff] border border-[#e2e8f0] rounded-2xl focus:border-[#2563eb] outline-none transition-all font-bold" />
                                    <Phone className="absolute right-4 top-1/2 -translate-y-1/2 text-[#2563eb]" size={20} />
                                </div>
                            </div>
                        </div>
                        <button onClick={nextStep} className="w-full py-4 bg-[#2563eb] text-white font-black rounded-2xl shadow-lg hover:brightness-110 active:scale-95 transition-all">
                            التالي
                        </button>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <input type="text" placeholder="أدخل اسم أكاديميتك" className="w-full p-4 pr-12 text-right bg-[#f8faff] border border-[#e2e8f0] rounded-2xl focus:border-[#2563eb] outline-none transition-all font-bold" />
                            ...
                            <div className="relative">
                                ...
                                <div className="relative">
                                    <input type="password" placeholder="********" className="w-full p-4 pr-12 text-right bg-[#f8faff] border border-[#e2e8f0] rounded-2xl focus:border-[#2563eb] outline-none transition-all font-bold" />
                                    <Lock className="absolute right-4 top-1/2 -translate-y-1/2 text-[#2563eb]" size={20} />
                                </div>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            <button onClick={nextStep} className="flex-[2] py-4 bg-[#2563eb] text-white font-black rounded-2xl shadow-lg hover:brightness-110 active:scale-95 transition-all">
                                إنشاء الحساب
                            </button>
                            <button onClick={prevStep} className="flex-1 py-4 bg-[#f8faff] border border-[#e2e8f0] text-[#4a4a4a] font-black rounded-2xl hover:bg-[#e2e8f0] transition-all">
                                رجوع
                            </button>
                        </div>
                    </div>

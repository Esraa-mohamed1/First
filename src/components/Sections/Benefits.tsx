                ...
                <div className="text-center mb-16 md:mb-24 relative z-10">
                    <h2 className="text-xl md:text-3xl font-black text-gray-900 leading-tight">
                        ...
                        <span className="relative inline-block mt-2">
                            ...
                            <span className="absolute bottom-1 md:bottom-2 left-0 w-full h-1 bg-yellow-300/60 -z-10 rounded-sm"></span>
                        </span>
                    </h2>
                </div>

                <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-44">
                    ...
                    <div className="flex-1 space-y-6 lg:space-y-10 order-1 lg:order-1 text-right w-full lg:w-[50%] pr-0 lg:pr-12">
                        {steps.map((step, index) => (
                            <div 
                                key={index} 
                                className={`flex items-center gap-4 lg:gap-6 group transition-transform duration-500 hover:lg:-translate-x-2 ${step.offset}`}
                            >
                                {/* Number */}

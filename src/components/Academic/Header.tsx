  ...
  return (
    <>
      <header className="bg-white border-b border-gray-100 sticky top-0 z-40">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between px-4 md:px-10 py-4 gap-4">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-[#2563eb] hover:bg-blue-700 text-white px-4 md:px-8 py-3 md:py-3.5 rounded-2xl font-black text-sm md:text-lg shadow-lg shadow-blue-100 transition-all transform hover:-translate-y-0.5 active:scale-95 whitespace-nowrap"
              >
          ...
          <div className="flex items-center gap-6 w-full md:w-auto justify-center md:justify-end">
             <h1 className="text-xl md:text-2xl font-black text-[#2563eb]">Prime Academy</h1>
          </div>
        </div>
      </header>

  ...
  return (
    <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-md relative overflow-hidden h-fit">
      ...
      <div className="space-y-4">
        ...
        <button className="w-full flex items-center justify-between p-4 bg-[#EAEFEF] hover:bg-gray-100/80 rounded-2xl border border-gray-100 transition-all group relative overflow-hidden">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-gray-400 shadow-sm group-hover:text-gray-600 transition-colors">
              <KeyRound size={18} />
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-[10px] font-bold flex items-center gap-1.5">

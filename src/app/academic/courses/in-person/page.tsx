  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-black text-gray-900">دورة حضوري</h1>
          <p className="text-gray-500 mt-1">إدارة الدورات الحضورية</p>
        </div>
        <button
          onClick={() => router.push('/academic/courses/create?type=physical')}
      ...
      <div className="bg-white rounded-2xl p-12 border border-gray-100 text-center">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2">لا توجد دورات حضورية</h3>
        <p className="text-gray-500 mb-6">ابدأ بإضافة دورتك الحضورية الأولى</p>
        <button
          onClick={() => router.push('/academic/courses/create?type=physical')}

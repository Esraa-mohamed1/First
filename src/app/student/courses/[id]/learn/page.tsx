...
export default function CoursePlayerPage() {
  ...
  useEffect(() => {
    ...
    // Reset video source and set loading to true when currentLesson or videoContext changes
    setActiveVideoSrc('');
  ...
  const renderSidebarContent = (isMobile = false) => {
    return (
      <>
        {/* Sidebar header */}
        <div className="px-5 py-6 lg:px-8 shrink-0 flex items-center gap-3 border-b border-slate-300 bg-white">
                        ...
                        if (isActive) {
                          return (
                            <button
                              ...
                              key={lesson.id}
                              onClick={() => setIsSidebarOpen(false)}
                              className="w-full bg-white rounded-[16px] p-3 flex items-center justify-between shadow-[0_8px_20px_rgba(0,0,0,0.06)] border-2 border-blue-500 transition-all cursor-default"
                            >
  ...
  return (
    <div className="flex flex-col font-sans min-h-screen bg-[#F1F5F9]" dir="rtl">
      {/* Custom Header matching the reference */}
      <header className="bg-white border-b border-slate-300 px-6 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        ...
        <div className="flex flex-1 flex-col min-h-0 w-full">
            ...
            <div className="max-w-[1600px] w-full mx-auto p-4 lg:p-10 space-y-10">
              <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-stretch">
                  ...
                  <div className="hidden lg:flex lg:col-span-3 flex-col bg-white rounded-[32px] md:rounded-[40px] shadow-md border-2 border-slate-300 overflow-hidden shrink-0">
                        ...
                        >
                          ...
                          <div className="px-3 pb-3 flex flex-col gap-2 shrink-0">
                            <button
                              ...
                              className="w-full py-2 bg-blue-600 hover:bg-blue-50 text-white rounded-xl font-black text-xs shadow-lg disabled:opacity-40 active:scale-95 transition-all"
                            >
                              حفظ واستئناف
                            </button>
                ...
                {/* Bottom Row: Lesson Details & Interactions */}
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 items-start">
                  {/* Empty space aligned under desktop sidebar to keep layout balanced */}
                  <div className="hidden lg:block lg:col-span-3" />

                  {/* Left Content - Details & Tabs */}
                  <div className="lg:col-span-7 space-y-6">
                    {/* Lesson Header & Actions */}
                    <div className="bg-white p-6 md:p-8 rounded-[32px] shadow-md border-2 border-slate-300 flex flex-col md:flex-row justify-between items-start gap-6">
                    ...
                    <div className="border-2 border-slate-300 bg-white rounded-[12px] overflow-hidden shadow-md">
                      {/* Shaded header */}
                      <div className="bg-slate-50 border-b-2 border-slate-300 px-6 py-4 flex items-center gap-3">
                    ...
                    <div className="border-2 border-slate-300 bg-white rounded-[12px] overflow-hidden shadow-md min-h-[500px] flex flex-col">
                      {/* Shaded tab header row */}
                      <div className="bg-slate-50 border-b-2 border-slate-300 flex items-center gap-1 px-4 shrink-0">
                        {[
          ...
          <aside
            className={cn(
              ...
              'fixed z-40 w-[min(100%,22rem)] h-full top-0 left-0 transition-transform duration-300 ease-out shadow-2xl lg:hidden',
      ...
      <AnimatePresence>
        {showCelebration && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm overflow-hidden"
          >

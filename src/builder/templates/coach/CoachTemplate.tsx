...
function parseSectionsToContent(nodes: any[], fallback: typeof DEFAULT_CONTENT) {
  ...
  return {
    ...
    about: aboutProps ? {
      ...
      description: aboutProps.description ?? aboutProps.bio,
    ...
    features: featuresProps ? {
      ...
      titleColor: featuresProps.titleColor ?? featuresProps.title_color,
      subtitleColor: featuresProps.subtitleColor ?? featuresProps.subtitle_color,
    } : fallback.features,

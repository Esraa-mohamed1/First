...
export default function Template3PricingEditor() {
  ...
  return (
    <div className="space-y-6 text-right font-sans" dir="rtl">
      <div>
        <h3 className="text-sm font-black text-slate-800 border-r-4 border-blue-600 pr-2">بطاقة التسجيل والدفع — قالب UI/UX</h3>
        <p className="text-[10px] text-slate-400 font-bold mt-1">تخصيص نص زر الاشتراك، عبارة الضمان، وقائمة المزايا المشتمل عليها التسجيل</p>
      </div>
